        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="text-center py-5 px-4 rounded-3 shadow-sm hero-section">
                    ...
                    <h1 class="mt-3 mb-3 fw-bold text-white">Benvingut a la Llibreria Provençana</h1>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm card-border-light">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="card-text text-muted">Consulta la llista de llibres disponibles a la llibreria.</p>
                    </div>
                </div>
            </div>
        </div>
